            ...
            <div>
                ...
                <form method="post" action="actions/createresume.action.php" class="row g-3 p-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="resume_title" placeholder="title" value="resume.<?=time()?>" class="form-control" required>
                    </div>
                    <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>
                    <div class="col-md-6">
                        <label class="form-label">Full Name</label>
                        <input type="text" name="full_name" placeholder="Abcd" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" name="email_id" placeholder="abcd@.com" class="form-control" required>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="mobile_no" min="1111111111" placeholder="9876543210" max="9999999999"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="languages" placeholder="Tamil,English" class="form-control" required>
                    </div>
