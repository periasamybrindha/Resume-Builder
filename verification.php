...
<div class="d-flex align-items-center p-2" style = "height:100vh">
        ...
        <main class="form-signin w-100 m-auto bg-white shadow rounded">
            <form method="post" action ="actions/verifyotp.action.php">
                ...
                <div class="mb-3">A 6 digit code sended to 
                    ...
                    <span class="mb-3 fw-bold"><?= $fn->getSession('email') ? $fn->getSession('email') : $fn->redirect('forgot-password.php') ?></span>

                </div>
                <div class="form-floating mb-4">
                    <input type="number" class="form-control" name="otp" id="floatingEmail" placeholder="name@example.com" required>
